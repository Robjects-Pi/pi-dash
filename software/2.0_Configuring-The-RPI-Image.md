...
You can either use the [custom rpi image (64-bit)]() or [custom rpi image (32-bit)]() with all the dependencies pre-installed or you can install the dependencies manually starting from the [base image (32 bit)](https://downloads.raspberrypi.com/raspios_lite_armhf/images/raspios_lite_armhf-2024-03-15/2024-03-15-raspios-bookworm-armhf-lite.img.xz) or [base image (64 bit)](https://downloads.raspberrypi.com/raspios_lite_arm64/images/raspios_lite_arm64-2024-03-15/2024-03-15-raspios-bookworm-arm64-lite.img.xz) and install the dependencies manually. 
...
The custom image has all the dependencies pre-installed, including Python, OpenCV, and FFmpeg. The custom image is recommended for those who are new to the Raspberry Pi and want to save time and effort. The base image is recommended for those with experience who want to apply their own Pi projects to the Pi-Dash project.
