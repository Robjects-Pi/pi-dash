...
0. **Install the ribbon cable and camera module**
1. **Clone the repository to the Raspberry Pi Zero**
2. **Configure the software for the DIY Dashboard project**
3. **Start recording videos with the Raspberry Pi Zero**
4. **Explanation of the code, variables, and python modules**
5. **Enable automatic recording on boot**
6. **Script to enable automatic recording on boot**
7. **Additional functionality**
8. **Conclusion**
9. 
10. **Configure the software from the repository on the Raspberry Pi Zero** (cloning isn't necessary for those who have already used the custom image)
...
## Prerequisites
### Step 0: Installing the ribbon cable and camera module
