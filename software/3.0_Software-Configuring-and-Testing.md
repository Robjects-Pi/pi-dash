...
> - The software is written in Python and uses the `picamera2` latest library to interface with the camera module.
>
> 

**Included in this section are instructions on how to**:

1. **Configure the software from the repository on the Raspberry Pi Zero** (cloning isn't necessary for those who have already used the custom image)
