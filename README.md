...
Say Goodbye to personal injury scams, and introduce yourself in the world of seamless integration to using data for your own purposes! The pi dash was designed to simplify data collection, and teach you how to aoutomatically record when utilizing your vehicle for a safer, more secure way to ensure you always have the recordings of your day-to-day commutes!

Using a enormous computer like a raspberry pi, the project takes advantage of pi zero (with pi4 options and code included), compacted in a tiny form factor to create a working, standalone device built from scratch that you combine or mix with unlimited capabilities. 
...
-  **[Working with Software for Rpi](#Software-for-rpi)** -
